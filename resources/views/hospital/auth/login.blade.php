...
<div class="container-scroller">
      <div class="container-fluid page-body-wrapper full-page-wrapper">
        <div class="row w-100 m-0">
          <div class="content-wrapper full-page-wrapper d-flex align-items-center auth bg-white ">
            <div class="card col-lg-4 mx-auto">
              <div class="card-body px-5 py-5">
                <h3 class="card-title text-left mb-3">Login</h3>
                <form role="form" method="POST" action="{{ route('hospital.login') }}" class="text-start">
                  @csrf
                  ...
                  <p class="sign-up">Don't have an Account?<a href="{{ route('hospital.register') }}#"> Sign Up</a></p>
                </form>
              </div>
            </div>
          </div>
