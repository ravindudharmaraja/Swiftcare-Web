                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                @foreach ($bookings as $booking)
                                    @if ($booking->ambulance_id == auth()->user()->id)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="" class="mx-3" data-bs-toggle="tooltip" data-bs-original-title="Delete Booking" onclick="event.preventDefault(); deleteBooking({{ $booking->id }})">
